...
!(function () {
		...
		l = (e) => (t) =>
			((e) => {
				...
				return null === e
					...
					? 'array'
					: 'object' === t &&
					  i(e, String, (e, t) => t.isPrototypeOf(e))
					? 'string'
					: t
			})(t) === e,
		d = (e) => (t) => typeof t === e,
	...
	const Ho = (e) => (t) => !!t && t.nodeType === e,
		...
		ts = (e) =>
			!es(e) &&
			(Xr(e) ? !Qr(e.parentNode) : Jr(e) || Gr(e) || Zr(e) || ns(e)),
		ns = (e) =>
			!((e) => qo(e) && 'true' === e.getAttribute('unselectable'))(e) &&
			Yr(e),
		os = (e, t) =>
			ts(e) &&
			((e, t) => {
	...
	const fs = (e) => Tn(yn(e)).exists((e) => !oo(e)),
		...
		hs = (e) => ps(e.nodeName),
		bs = (e) =>
			'svg' === (null == e ? void 0 : e.nodeName) ? 'svg' : 'html',
		vs = ['svg'],
		ys = 'data-mce-block',
		Cs = (e) =>
			q(
		...
		_s = (e, t, n) => {
			...
			V(_o(n), (t) => {
				Qn(t, s, a).each((n) => {
					const o = ((t, o) =>
						Y(Mn(t), (t) => s(t) && !e.isValidChild(Ht(n), Ht(t))))(
						t,
					)
					if (o.length > 0) {
						const t = Tn(n)
		...
		Ms = (e, t = {}) => {
				...
				d = (e) =>
					new Promise((n, r) => {
						...
						Zt(g, {
							...
							t.contentCssCors &&
								Jt(g, 'crossOrigin', 'anonymous'),
							t.referrerPolicy &&
								Jt(g, 'referrerpolicy', t.referrerPolicy),
							(i = g.dom),
							(i.onload = m),
							(i.onerror = f),
							a(g),
			...
			return {
				...
				loadAll: (e) =>
					Promise.allSettled(q(e, (e) => d(e).then(N(e)))).then(
						(e) => {
			...
			const s = {},
				...
				d = ((e) => {
					...
					return (
						...
						a(
							'link',
							'href rel media hreflang type sizes hreflang',
						),
						...
						a(
							'img',
							'src sizes srcset alt usemap ismap width height',
						),
						...
						'html5-strict' !== e &&
							...
							i(
								'img',
								'name longdesc align border hspace vspace',
							),
							i(
								'iframe',
							...
							i('textarea'),
							i(
								'h1 h2 h3 h4 h5 h6 div p legend caption',
								'align',
							),
							i('ul', 'type compact'),
							i('li', 'type'),
						...
						'html4' !== e &&
							...
							i(
								'iframe',
								'sandbox seamless allow allowfullscreen loading',
							)),
						'html4' !== e &&
							V([r.video, r.audio], (e) => {
		...
		Ea = (e, t) => {
			...
			return (
				...
				C(e.getTargetRanges) &&
					(n.getTargetRanges = () => e.getTargetRanges()),
				n
			)
		},
		_a = (e, t, n, o) => {
			...
			return (
				...
				y(s.target) &&
					(s.target =
						null !== (r = s.srcElement) && void 0 !== r ? r : n),
				((e) =>
					y(e.preventDefault) ||
					...
					((e) =>
						...
						e.isDefaultPrevented === L)(s) ||
						((s.isDefaultPrevented =
							!0 === s.defaultPrevented ? M : L),
						(s.isPropagationStopped =
							!0 === s.cancelBubble ? M : L),
		...
		za = (e, t = {}) => {
			...
			const a = Is.forElement(yn(e), {
				...
				A = (e, t, n, o) => {
					...
					o = void 0 === o
					const a =
						n || ('BODY' !== x().nodeName ? x().parentNode : null)
					if (m(t))
						if ('*' === t) t = qo
						else {
							const e = t
				...
				Y = {
					...
					createFragment: (t) => {
						...
						let r
						for (
							o.appendChild(n), t && (n.innerHTML = t);
							(r = n.firstChild);
	...
	const $a = (e) => {
			...
			translate: (e) => {
				const t = Wa().getOr({}),
					...
					r = (e) => {
						...
						return Ee(t, o)
							? n(t[o])
							: xe(t, o.toLowerCase()).map(n).getOr(o)
					},
		...
		Ya = () => {
			...
			return {
				...
				add: (t, o) => (
					e.push(o), (n[t] = { instance: o }), r(t, 'added'), o
				),
				remove: (e) => {
	...
	const ui = (e) => {
		...
		xi = (e, t) =>
			e.top > t.bottom ||
			(!(e.bottom < t.top) && Ci(t.bottom - e.top, e, t)),
		Ei = (e, t, n) => {
		...
		ki = (e, t) => {
			if (qo(e) && e.hasChildNodes()) {
				const n = e.childNodes,
					o = ((e, t, n) => Math.min(Math.max(e, 0), n))(
						t,
						0,
						n.length - 1,
					)
		...
		Mi = za.nodeIndex,
		Ii = (e, t) =>
			t < 0 && qo(e) && e.hasChildNodes() ? void 0 : ki(e, t),
		...
		Vi = (e, t, n) => {
			...
			return {
				...
				isAtStart: () => (Di(e), 0 === t),
				isAtEnd: () =>
					Di(e) ? t >= e.data.length : t >= e.childNodes.length,
	...
	const Wi = (e, t) => {
		...
		el = (e) =>
			...
			((e) => {
				...
				const o = Oe(
					t,
					(e, n, o) => (Yi(n) && Yi(t[o - 1]) && e++, e),
					0,
				)
				return (
					(t = Te(t, Ko([e.nodeName]))), (n = Be(t, Zi(e), e)), n - o
				)
			})(e) +
			']',
		tl = (e, t) => {
		...
		nl = (e, t) => {
			...
			if (!Yi(s) && s.parentNode) {
				let e
				return (
					(e = 'after' === r ? Xi(s) + 1 : Xi(s)), Vi(s.parentNode, e)
				)
			}
			return ((e, t) => {
				let n = e,
				...
				return (
					Yi(e) && t > e.data.length && (t = e.data.length), Vi(e, t)
				)
			})(s, parseInt(r, 10))
		},
		ol = dr,
		...
		dl = (e, t, n) => {
			...
			const s = ((e) =>
				...
				ll(e.endContainer, e.endOffset))(r)
			if (s) {
				const e = s.tagName
	...
	const bl = (e) => 'inline-command' === e.type || 'inline-format' === e.type,
		...
		xl = (e) => {
			...
			return (
				V(t.errors, (e) => console.error(e.message, e.pattern)),
				t.values
			)
		},
		El = xt().deviceType,
		...
		Rc = (e) => {
			wc(e) &&
				Ur(e) &&
				(zr(e) ? e.removeAttribute('data-mce-caret') : Ec(e)),
						...
						const n = ((e, t, n) => {
								...
								return (
									n
										...
										: t.nextSibling
										? null == s ||
										  s.insertBefore(r, t.nextSibling)
	...
	const uu = dr,
		...
		hu = (e) =>
			...
			((e) =>
				!!ns(e) &&
				!X(ce(e.getElementsByTagName('*')), (e, t) => e || Kr(t), !1))(
				e,
			),
		bu = os,
		vu = (e, t) =>
			e.hasChildNodes() && t < e.childNodes.length
				? e.childNodes[t]
				: null,
		yu = (e, t) => {
			if (Wc(e)) {
			...
			ku(e, t, n).bind((o) =>
				...
				((e, t, n) => {
					return e
						? !_u(t, n) &&
								((o = t),
								!(!Vi.isTextPosition(o) && ar(o.getNode()))) &&
								Eu(t) &&
								xu(n)
						: !_u(n, t) && xu(t) && Eu(n)
					var o
					...
					if (Mu(t))
						return ((e, t) =>
							I.from(e.select(t.name)[t.index]).map((t) => {
								const n = e.createRng()
								return (
									n.selectNode(t), { range: n, forward: !0 }
								)
							}))(n, t)
					if (((e) => Ee(e, 'rng'))(t))
	...
	const Xu = (e) => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
		...
		xm = (e, t) => {
			...
			return (
				e.getParent(
					...
					(t) =>
						!!qo(t) &&
						((n = e.getStyle(t, 'text-decoration')),
						!!n && 'none' !== n),
				),
				n
			)
		...
		Mm = (e, t, n, o) => {
			...
			if (e) {
				...
				for (let e = n; e < r.length; e++) if (o(r.charAt(e))) return e
			return -1
		},
		...
		Um = (e, t, n, o, r, s) => {
			...
			return l(n, o, Im)
				...
				.orThunk(() =>
					a
						? I.some({ container: a, offset: r ? 0 : a.length })
						: I.none(),
				)
		},
		zm = (e, t, n, o, r) => {
		...
		jm = (e, t, n, o) => {
			...
			const a = e.getRoot(),
				i = t[0]
			if (
				(km(i) && (s = i.wrapper ? null : e.getParent(n, i.block, a)),
				!s)
			) {
				const t =
					null !== (r = e.getParent(n, 'LI,TD,TH,SUMMARY')) &&
					void 0 !== r
						? r
						: a
				s = e.getParent(
		...
		Hm = (e, t, n, o) => {
			...
			return (
				!C(n[o]) &&
				(!(r !== t && !y(r) && !e.isBlock(r)) || Hm(e, t, r, o))
			)
		},
		$m = (e, t, n, o, r) => {
			let s = n
		...
		Vm = (e, t, n, o = !1) => {
			...
			return (
				...
				qo(r) &&
					r.parentNode &&
					((s = e.nodeIndex(r)), (r = r.parentNode)),
				qo(a) &&
					a.parentNode &&
					((i = e.nodeIndex(a) + 1), (a = a.parentNode)),
				{
					startContainer: r,
					startOffset: s,
					endContainer: a,
			...
			const x = (e) => C(e) && (ir(e) || n.is(e, 'figure.image')),
				...
				N = (e, o, r) => {
					if (C(r)) {
						...
						V(s, (e) => {
							e.style[o] ||
							!t.schema.isValid(e.nodeName.toLowerCase(), o)
								? n.setStyle(e, o, r)
								: n.setAttrib(e, o, '' + r)
						})
					}
				...
				A = (e) => {
					...
					;(o = e.screenX - u),
						...
						(r = s.scrollHeight - w),
						o + r !== 0 &&
							n.setStyles(l, { left: C - o, top: _ - r }),
						h ||
							(((e, t, n, o, r) => {
	...
	const bf = (e, t, n, o) => ({
		...
		vf = document.caretPositionFromPoint
			? (e, t, n) => {
					var o, r
					return I.from(
						null === (r = (o = e.dom).caretPositionFromPoint) ||
							void 0 === r
							? void 0
							: r.call(o, t, n),
					).bind((t) => {
			...
			? (e, t, n) => {
					var o, r
					return I.from(
						null === (r = (o = e.dom).caretRangeFromPoint) ||
							void 0 === r
							? void 0
							: r.call(o, t, n),
					)
		...
		xf = {
			...
			exact: wf.exact,
			exactFromRange: (e) =>
				wf.exact(e.start, e.soffset, e.finish, e.foffset),
			getWin: (e) => {
				const t = ((e) =>
					e.match({
	...
	const qf = (e) => 'textarea' === Ht(e),
		Vf = (e, t) => {
			const n = ((e) => {
					...
					const s = Oo(
							null == o ? void 0 : o.pageYOffset,
							r.scrollTop,
						),
						a = Oo(
							null == o ? void 0 : o.pageXOffset,
							r.scrollLeft,
						),
	...
	const Cg = za.DOM,
		...
		_g = (e, t) => {
					...
					e.inline &&
						...
						((e, t) => {
							;((e, t) => {
								...
								e.on(
									'keyup NodeChange AfterSetSelectionRange',
									(t) => {
										;((e) =>
											'nodechange' === e.type &&
											e.selectionChange)(t) || pg(e)
									},
								)
						})(e, t)
				}),
			...
			const o = (e, t) => {
				mc(e) &&
					!0 !== e.inline &&
					t(yn(e.getContainer()), 'tox-edit-focus')
			}
			n.on('focusin', () => {
			...
			return (
				(o =
					'raw' === t.format
						? Pt.trim(
								Dr(
									sp(n, e.serializer.getTempAttrs())
										.innerHTML,
								),
						  )
						: 'text' === t.format
	...
	const fp = ['font', 'text-decoration', 'text-emphasis'],
		...
		yp = (e) => {
			...
			return (
				er(t) &&
				(0 === t.data.length ||
					(Pr(t.data) && Jm.isBookmarkNode(t.parentNode)))
			)
		},
		Cp = (e, t) => (n) =>
			Jc(e ? 0 : -1, n)
		...
		xp = (e) =>
			dr(e) &&
			!((e) => qo(e) && 'all' === e.getAttribute('data-mce-bogus'))(e),
		Ep = Cp(!0, wp),
		_p = Cp(!1, wp),
		kp = Cp(!0, mr),
		Sp = Cp(!1, mr),
		...
		Op = (e, t) =>
			((e, t, n) =>
				kn(t, e) ? On(e, (e) => n(e) || _n(e, t)).slice(0, -1) : [])(
				e,
				t,
				L,
			),
			...
			(Ip(e, t, n) ||
				...
				((e, t) => {
					const n = Tu(e.dom, t).getOr(t),
						o = Jp(e.dom, 'prev')
					return (
						t.isAtStart() && (o(t.container()) || o(n.container()))
					)
				})(e, t)),
		th = (e, t, n) =>
			!Qp(t) &&
				...
				return (
					...
					(d = (e, t, r) => {
						const s = e.dom,
							...
							i = s.data.length
						return (
							uh(s, a, n, o), r.container() === a ? Vi(s, i) : r
						)
					}),
		...
		yh = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
		Ch = (e, t) =>
			xn(yn(t), dd(e)) && !Ts(e.schema, t) && e.dom.isEditable(t),
		wh = (e) => {
			var t
			return (
		...
		xh = (e, t, n) => {
			const o = ((e, t, n) =>
				Y(za.DOM.getParents(n.container(), '*', t), e))(e, t, n)
		...
		Ph = (e, t, n, o = !0) => {
			...
			const s = Bh(n).getOr(n),
				a = yn(
					null !== (r = e.dom.getParent(s.dom, e.dom.isBlock)) &&
						void 0 !== r
						? r
						: n.dom,
				)
			if (
				(a.dom === e.getBody()
					? Th(e, o)
					: gs(a) &&
					  (Or(a), o && e.selection.setCursorLocation(a.dom, 0)),
				!_n(n, a))
			) {
				const e = Dt(An(a), n)
					? []
				...
				const o = e.selection.getRng(),
					r = n
						.bind(({ rng: n, isStartInTable: r }) => {
							const s = ((e, t) =>
								I.from(e.dom.getParent(t, e.dom.isBlock)).map(
									yn,
			...
			return ob(o, n).fold(
				() =>
					((e, t, n, o) => {
						...
						It(
							((e, t) => {
								const n = Vi.fromRangeStart(
									e.selection.getRng(),
								)
								return (
									sb(t, n) ||
									ku(t, e.getBody(), n).exists((e) =>
										sb(t, e),
									)
								)
							})(e, t),
			...
			if (n.attributes)
				for (let e = 0, r = t.length; e < r; e++) {
					...
					if (s in n.attributes.map) {
						...
						e
							? e.nodes.push(n)
							: (o.attributes[s] = { filter: r, nodes: [n] })
					}
				}
		},
		gb = (e, t) => {
					...
					return (
						...
						(t.isEmpty(n) ||
							((e, t) =>
								...
								((e) =>
									C(e.firstChild) &&
									e.firstChild === e.lastChild)(t) &&
								((e) => 'br' === e.name || e.value === br)(
									t.firstChild,
								))(e, t))
					)
		...
		Rb = (e, t, n, o) => {
			const r = ((e, t, n) => {
				...
				a = kb(
					((i = r.firstChild),
					Y(
						null !== (l = null == i ? void 0 : i.childNodes) &&
							void 0 !== l
							? l
							: [],
						(e) => 'LI' === e.nodeName,
			...
			return s
				? c(1)
					...
					: c(2)
					? ((e, t, n, o) => (
							o.insertAfter(t.reverse(), e), Nb(t[0], n)
					  ))(s, a, d, t)
					: ((e, t, n, o) => {
							const r = ((e, t) => {
			...
			m === f &&
				...
				s.isCollapsed() ||
					((e) => {
						...
						;((e, t, n) =>
							!!C(n) &&
							n === e.getParent(t.endContainer, Tb) &&
							rm(yn(n), t))(t, n, o)
							? eb(e, n, yn(o))
				...
				((e, t, n, o) => {
					...
					if (i && l) {
						const t = 'false' !== s.attr('contenteditable'),
							a =
								(null === (r = e.getParent(n, e.isBlock)) ||
								void 0 === r
									? void 0
				...
				p.invalid ||
					((e, t, n) => {
						...
						return (
							$(n.children(), mb) &&
							'SUMMARY' ===
								(null === (o = e.getParent(t, e.isBlock)) ||
								void 0 === o
									? void 0
									: o.nodeName)
						)
		...
		Fb = (e, t, n, o, r) => {
			...
			const a = e.dom.getParent(
				t,
				(t) =>
					!!Ib(e, t, n) || t.parentNode === s || !!jb(e, t, n, o, !0),
			)
			return !!jb(e, a, n, o, r)
		},
		Ub = (e, t, n) =>
			...
			if (Am(t)) vh(e, !1, yn(t), n, !0)
				...
				const e = r.getRng(),
					...
					d = ((e) => {
						const t = qb(e)
						return (
							t && t.data.charAt(0) === $b && t.deleteData(0, 1),
							t
						)
					})(t)
				o.remove(t, !0),
	...
	const nv = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
		...
		_v = (e, t, n, o, r) => {
			const s = yn(t),
				...
				i = n ? Ln(s) : Dn(s)
			return (
				Co(a, i), n ? (po(s, a), bo(a, s)) : (ho(s, a), vo(a, s)), a.dom
			)
		},
		kv = (e, t, n) => {
			const o = t.parentNode
		...
		Av = (e, t, n, o, r) => {
			...
			if (
				!t.ceFalseOverride &&
				o &&
				'false' === s.getContentEditableParent(o)
			)
				return hv.keep()
			if (
				o &&
				!Ub(s, o, t) &&
				!((e, t) => t.links && 'A' === e.nodeName)(o, t)
			)
				return hv.keep()
			const l = o,
		...
		Tv = (e, t, n, o) =>
			Av(e, t, n, o, o).fold(
				N(o),
				(t) => (
					e.dom.createFragment().appendChild(o), e.dom.rename(o, t)
				),
				N(null),
			),
		Ov = (e, t, n, o, r) => {
		...
		zv = (e, t, n, o, r) =>
			Q(
				...
				(t) =>
					!!Ib(e, t, n) ||
					(!o && C(e.formatter.matchNode(t, n, r, !0))),
			),
		jv = (e, t) => {
	...
	const Qv = (e, t, n) =>
		...
		ty = (e, t) => {
			...
			t.validate &&
				...
				t.sandbox_iframes &&
					e.addNodeFilter('iframe', (e) =>
						V(e, (e) => e.attr('sandbox', '')),
					)
		},
		{
			entries: ny,
				...
				if (!we || we !== e) {
					if (
						...
						re &&
							...
							!0 === re.svgFilters &&
								(ky(M, Ty), ky(F, My), ky(F, Fy)),
							!0 === re.mathMl &&
								(ky(M, By), ky(F, Iy), ky(F, Fy))),
						e.ADD_TAGS &&
							(M === I && (M = Sy(M)), ky(M, e.ADD_TAGS, Ce)),
						e.ADD_ATTR &&
							(F === U && (F = Sy(F)), ky(F, e.ADD_ATTR, Ce)),
	...
	const iC = (e, t, n, o, r) => {
						...
						return (
							x &&
								...
								((e, n) => {
									...
									if (
										t.isValidChild(e.name, n.toLowerCase())
									) {
										for (; i; ) {
											const t = i.next
											g(o, i)
		...
		vC = (e, t, n) => {
			const o = ((e) => (Bb(e) ? up({ validate: !1 }).serialize(e) : e))(
					e,
				),
				r = t(o)
		...
		GC = (e) => ({
			...
			undoManager: {
				...
				hasUndo: (t, n) =>
					((e, t, n) =>
						n.get() > 0 ||
						(t.typing && t.data[0] && !VC(jC(e), t.data[0])))(
						e,
						t,
						n,
					),
				...
				transact: (e, t, n) =>
					((e, t, n) => (
						YC(e, t), e.beforeChange(), e.ignore(n), e.add()
					))(e, t, n),
				ignore: (e, t) =>
					((e, t) => {
						try {
				...
				extra: (t, n, o, r) =>
					((e, t, n, o, r) => {
						if (t.transact(o)) {
							...
							HC(e, s, !0),
								t.transact(r) &&
									(t.data[n.get() - 1].beforeBookmark = o)
						}
					})(e, t, n, o, r),
			},
			formatter: {
		...
		tw = (e, t, n, o, r) => {
			e.bind(
				...
				const e = ((e, t) =>
					e
						.filter((e) => Jm.isBookmarkNode(e.dom))
						.bind(t ? Pn : Bn))(t, o)
					.or(t)
					.filter(Kt)
				return e.map((e) =>
	...
	const ow = (e) =>
			!(!e || !e.ownerDocument) && kn(yn(e.ownerDocument), yn(e)),
		rw = (e, t, n, o) => {
			let r, s
			const { selectorChangedWithUnbind: a } = ((e, t) => {
				...
				c = () => {
					...
					return (
						r &&
							s &&
							(0 === a(n.START_TO_START, n, r) &&
							0 === a(n.END_TO_END, n, r)
								? (n = s)
								: ((r = null), (s = null))),
						n
					)
				...
				u = (e, t) => {
					if (
						!((e) =>
							!!e && ow(e.startContainer) && ow(e.endContainer))(
							e,
						)
					)
						return
					...
					getSelectedBlocks: (t, n) =>
						((e, t, n, o) => {
							const r = [],
								s = e.getRoot(),
								a = e.getParent(
									n || Pg(s, t, t.collapsed),
									e.isBlock,
								),
								i = e.getParent(
									o || Dg(s, t, t.collapsed),
									e.isBlock,
								)
							if (
								(a && a !== s && r.push(a), a && i && a !== i)
							) {
								let t
								const n = new jo(a, s)
								for (; (t = n.next()) && t !== i; )
					...
					serialize: (e, n = {}) => {
						const i = { format: 'html', ...n },
							l = ((e, t, n) =>
								((e, t) =>
									C(e) &&
									e.hasEventListeners('PreProcess') &&
									!t.no_events)(e, n)
									? ((e, t, n) => {
											let o
											const r = e.dom
						...
						return 'tree' === i.format
							...
							: ((e, t, n, o, r) => {
									const s = ((e, t, n) =>
										up(e, t).serialize(n))(t, n, o)
									return ((e, t, n) => {
										if (!t.no_events && e) {
											const o = ((e, t) =>
												e.dispatch('PostProcess', t))(
												e,
												{ ...t, content: n },
											)
											return o.content
		...
		yw = (e) =>
			J(mw, (t) => t.name === e).fold(
				() => e,
				(t) =>
					t.replacedWith ? `${e}, replaced by ${t.replacedWith}` : e,
			),
		Cw = za.DOM,
		...
		Tw = (e) => {
			const t = [],
				...
				a = (a, i = !0) =>
					...
					!((e) => {
						...
						? {}
						: (i &&
								e.dispatch('BeforeOpenNotification', {
									notification: a,
								}),
						  J(t, (e) => {
								return (
			...
			return (
				((e) => {
					e.on('SkinLoaded', () => {
						const t = gd(e)
						t && a({ text: t, type: 'warning', timeout: 0 }, !1),
							r()
					}),
						e.on(
							'show ResizeEditor ResizeWindow NodeChange',
							() => {
		...
		jw = (e, t) => {
			...
			return {
				findAll: (o, r = M) => {
					const s = Y(
							((e) =>
								e ? ce(e.getElementsByTagName('img')) : [])(o),
							(t) => {
								const n = t.src
								return (
						...
						a = q(s, (e) => {
							...
							if (Ee(n, o))
								return n[o].then((t) =>
									m(t)
										? t
										: { image: e, blobInfo: t.blobInfo },
								)
							{
								const r = ((e, t) => {
									const n = () =>
										Promise.reject('Invalid data URI')
									if (He(t, 'blob:')) {
	...
	const qw = (e, t) => {
			...
			const n = (t && t.schema) || ua({}),
				...
				r = (e, t, s) => {
					...
					const i = t[0],
						...
						d = ((e, t) => {
							const o = n.getElementRule(
									e.nodeName.toLowerCase(),
								),
								r = null == o ? void 0 : o.parentsRequired
							return (
								!(!r || !r.length) && (t && H(r, t) ? t : r[0])
							)
						})(e, l)
		...
		rx = (e) => {
								...
								const t = e.dom,
									...
									o = {
										...
										alignleft: [
											...
											{
												selector:
													'.mce-preview-object,[data-ephox-embed-iri]',
												ceFalseOverride: !0,
												styles: { float: 'left' },
											},
										],
			...
			return (
					...
					})(n, e),
				{
					...
					closest: (t) =>
						((e, t) => JC(e).formatter.closest(t))(e, t),
					matchAll: (t, n) =>
						((e, t, n) => JC(e).formatter.matchAll(t, n))(e, t, n),
					matchNode: (t, n, o, r) =>
						((e, t, n, o, r) =>
							JC(e).formatter.matchNode(t, n, o, r))(
							e,
							t,
							n,
							o,
					...
					canApply: (t) =>
						((e, t) => JC(e).formatter.canApply(t))(e, t),
					formatChanged: (t, o, r, s) =>
						((e, t, n, o, r, s) =>
							JC(e).formatter.formatChanged(t, n, o, r, s))(
							e,
							n,
							t,
							o,
		...
		ax = (e) => {
			const t = Xa(),
				...
				r = {
					...
					add: (s, a) =>
						((e, t, n, o, r, s, a) =>
							JC(e).undoManager.add(t, n, o, r, s, a))(
							e,
							r,
							o,
							n,
					...
					undo: () =>
						((e, t, n, o) => JC(e).undoManager.undo(t, n, o))(
							e,
							r,
							n,
							o,
					...
					redo: () =>
						((e, t, n) => JC(e).undoManager.redo(t, n))(
							e,
							o,
							r.data,
						),
					...
					transact: (t) =>
						((e, t, n, o) => JC(e).undoManager.transact(t, n, o))(
							e,
							r,
							n,
							t,
		...
		gx = (e, t) => {
			const n = ((e, t) => {
				const n = Mn(e)
				return Z(n, (e) => t.isBlock(Ht(e))).fold(N(n), (e) =>
					n.slice(0, e),
				)
			})(e, t)
			return V(n, xo), n
						...
						? ((e, t, n) => {
								...
								return Mt(o, r, ux).filter(
									(t) =>
										...
										((e) =>
											!1 === dr(e.from.block.dom) &&
											!1 === dr(e.to.block.dom))(t) &&
										((e) => {
											const t = (e) => _r(e) || Ns(e.dom)
											return (
												t(e.from.block) && t(e.to.block)
											)
										})(t),
								)
						  })(e, t, n)
						: I.none())(n.dom, t, e.selection.getRng()).map(
					(o) => () => {
						Cx(n, t, o.from.block, o.to.block, e.schema).each(
							(t) => {
		...
		Ex = (e) => {
			...
			return ((e, t) => {
				...
				return (
					!((e, t) =>
						xx(e, t.startContainer) || xx(e, t.endContainer))(
						e,
						t,
					) &&
					n &&
		...
		kx = (e, t, n, o, r) =>
			I.from(t._selectionOverrides.showCaret(e, n, o, r)),
		Sx = (e, t) =>
			e
							...
							(n) => () =>
								n.fold(
									...
									((e, t) => (n) => {
										...
										return (
											e.selection.setRng(o.toRange()), !0
										)
									})(e, t),
									((e) => (t) => (
										e.selection.setRng(t.toRange()), !0
									))(e),
								),
						),
					() => I.some(_),
			...
			e
				? ((e) => {
						...
						if (jx(e.previousSibling))
							return (
								$x(e.previousSibling) ||
									e.previousSibling.appendData(Br),
								e.previousSibling
							)
	...
	const UE = (e, t, n, o, r, s) => {
					...
					yd(e) &&
						...
						((e, t, n, o) => {
							if (t.selection.isCollapsed()) {
								const r = Y(o, e)
								V(r, (o) => {
									const r = Vi.fromRangeStart(
										t.selection.getRng(),
									)
									iE(e, t.getBody(), r).bind((e) =>
										ZE(t, n, e),
									)
								})
							}
		...
		g_ = (e, t) => {
			const n = Y(
				((e) =>
					c_(
						e,
						(t) => e.schema.isBlock(Ht(t)) || ((e) => zn(e) > 1)(t),
					))(e),
				u_,
			)
			return de(n).bind((o) => {
			...
			const n = e.selection.getStart(),
				o =
					((e, t) => {
						...
						? Jb(n, t)
						: ((e, t) => {
								const { caretContainer: n, caretPosition: o } =
									Qb(t)
				...
				((e) =>
					((e) =>
						...
						((e) => {
							...
							return (
								e.endOffset ===
								(er(t) ? t.length : t.childNodes.length)
							)
						})(e))(e) ||
					((e) =>
						!e.endContainer.isEqualNode(e.commonAncestorContainer))(
						e,
					))(t)
			)
		},
				...
				(t.length > 1 ||
					((e, t) =>
						ne(t, (t) => {
							...
							return (
								'false' !== e.dom.getContentEditable(t.dom) &&
								o > 0
							)
						}))(e, t))
			)
		...
		N_ = (e) =>
			Y(
				...
				(e) =>
					!S_(e) &&
					!((e) => An(e).exists(S_))(e) &&
					Jn(e, (e) => lr(e.dom) || dr(e.dom)).exists((e) =>
						lr(e.dom),
					),
			),
		R_ = (e, t) => {
		...
		O_ = (e, t, n) =>
			ue(
				[T_, Ux, Ox, (e, n) => d_(e, t, n), wx, ib, zx, x_, _x, v_],
				(t) => t(e, n),
			...
			function (o) {
				...
				if ('>' === a) {
					...
					if (
						-1 !== e &&
						-1 !==
							t.substring(e, s).indexOf('contenteditable="false"')
					)
						return o
				}
				return (
							...
							.map((t) =>
								((e, t) => {
									...
									return !(
										...
										!AE(t, o) ||
										(e.execCommand('InsertNewBlockAfter'),
										0)
									)
								})(e, t),
							)
		...
		hk = (e, t, n) => {
			const o = e(t, n)
			return ((e) => e.breakType === hE.Wrap && 0 === e.positions.length)(
				o,
			) ||
				(!ar(n.getNode()) &&
					((e) => e.breakType === hE.Br && 1 === e.positions.length)(
						o,
					))
				? !((e, t, n) =>
						n.breakAt.exists((n) => e(t, n).breakAt.isSome()))(
						e,
						t,
						o,
				  )
		...
		xk = (e, t, n) =>
			I.from(e.dom.getParent(e.selection.getNode(), 'td,th'))
				.bind((o) =>
					I.from(e.dom.getParent(o, 'table')).map((r) =>
						n(e, t, r, o),
					),
				)
				.getOr(!1),
				...
				() =>
					((e, t, n, o = 0) => {
						...
						const s = { text: '', offset: 0 },
							a =
								e.getParent(t.startContainer, e.isBlock) ||
								e.getRoot()
						return Lk(
							e,
							t.startContainer,
		...
		Hk = (e, t, n, o = {}) => {
			...
			const s = t(),
				a =
					null !==
						(r = e.selection.getRng().startContainer.nodeValue) &&
					void 0 !== r
						? r
						: '',
				i = Y(
							...
							((e) => (t) => {
								...
								return !((e, t) => {
									...
									return Lk(
										...
										.filter((e) => {
											const t = e.container.data.charAt(
												e.offset - 1,
											)
											return !Ik(t)
										})
	...
	const qk = (e, t, n) => (e.stype === $k.Error ? t(e.serror) : n(e.svalue)),
		...
		Zk =
			(Qk((e, t) => t),
			(e) => ({ tag: 'defaultedThunk', process: N(e) })),
		eS = (e) => {
			const t = ((e) => {
				const t = [],
					n = []
	...
	const XS = (e) => {
			const t = e.ui.registry.getAll().popups,
				n = pe(t, (e) => {
					return ((t = e),
					lS('Autocompleter', zS, { trigger: t.ch, ...t })).fold(
						(e) => {
							throw new Error(
								'Errors: \n' +
									((e) => {
				...
				a = (a) => {
					;((n) =>
						t
							.get()
							.map((t) =>
								Uk(e.dom, e.selection.getRng(), t.trigger).bind(
									(t) => Hk(e, s, t, n),
								),
							)
							.getOrThunk(() =>
			...
			return 'selection' === o
				? ((e, t) => {
						const n = t.startSummary.exists((t) =>
							...
							o = t.startSummary.exists((t) =>
								t.contains(e.endContainer),
							),
						...
						t.startDetails.exists((n) =>
							Tu(n, e).forall((n) =>
								t.startSummary.exists(
									(t) =>
										!t.contains(e.container()) &&
										t.contains(n.container()),
								),
							),
						))(s, t)
		},
		...
		ON = {
			insert: (e, t) => {
				...
				qo(n) &&
					...
					(n =
						n.childNodes[Math.min(o, n.childNodes.length - 1)] ||
						n),
				...
				if (
					...
					((e, t) => {
						...
						return (
							null !== n &&
							'false' === e.dom.getContentEditableParent(n)
						)
					})(e, n)
				)
					return
					...
					(n = ((e, t, n, o, r) => {
						...
						if (!d || !AN(i, d)) {
							...
							if (
								s &&
								u &&
								e.schema.isValidChild(u, t.toLowerCase())
							) {
				...
				if (p)
					...
					const t =
						yn(d.startContainer).dom.hasChildNodes() && d.collapsed
					pN(e, RN(k, 'HR') || t ? R : k)
				} else {
					const t = ((e) => {
						const t = e.cloneRange()
						return (
							...
							t.setEnd(
								e.endContainer,
								TN(!1, e.endContainer, e.endOffset),
							),
							t
						)
					})(d).cloneRange()
				...
				n.isSome()
					...
					: ((e, t) => {
							...
							if (qo(l) && l.hasChildNodes()) {
								...
								;(l =
									l.childNodes[
										Math.min(i, l.childNodes.length - 1)
									] || l),
		...
		qN = (e, t) => (n, o) => {
			const r =
				((e) => bN(e).fold(N(''), (e) => e.nodeName.toUpperCase()))(
					n,
				) === e.toUpperCase()
			return r === t
		},
	...
	const _R = ui('mode'),
		...
		JR = (e, t, n) =>
			!!((e, t) =>
				XR(t) &&
				$(pc(e), (e) => $e(t.toLowerCase(), `.${e.toLowerCase()}`)))(
				e,
				t,
			) &&
			((e, t, n) => (
			...
			const s = ((e, t, n) =>
				((e, t, n) => {
					...
					return e.hasEventListeners('PastePostProcess') &&
						!o.isDefaultPrevented()
						? ((e, t, n) => {
								const o = e.dom.create(
										'div',
										{ style: 'display:none' },
										t,
									),
									r = ((e, t, n) =>
										e.dispatch('PastePostProcess', {
											node: t,
											internal: n,
										}))(e, o, n)
								return YR(
			...
			;((e, t, n) => {
				...
				e.on('keydown', (e) => {
					...
					e.on('paste', (r) => {
						...
						;(!aA(a) &&
							iA(e, r, t.getLastRng() || e.selection.getRng())) ||
							(sA(a, 'text/html')
								? (r.preventDefault(),
								  lA(e, a, a['text/html'], s, !0))
								: sA(a, 'text/plain') && sA(a, 'text/uri-list')
								? (r.preventDefault(),
								  lA(e, a, a['text/plain'], s, !0))
								: (t.create(),
								  vg.setEditorTimeout(
										e,
										() => {
	...
	const RA = (e, t) => Math.abs(e.left - t),
						...
						((e, t) => {
							const n =
								((e, t) =>
									Math.max(
										0,
										Math.min(e.bottom, t.bottom) -
											Math.max(e.top, t.top),
									))(e, t) / Math.min(e.height, t.height)
							return (
								((e, t) =>
									e.top < t.bottom && e.bottom > t.top)(
									e,
									t,
								) && n > 0.5
							)
					...
					const r = (t, s) => {
						const a = Y(
							...
							O(
								(e) =>
									qo(e) &&
									e.classList.contains('mce-drag-container'),
							),
						)
						return s
							.fold(
		...
		DA = (e) => {
			...
			return {
				top:
					o.top +
					(null !== (t = null == a ? void 0 : a.scrollY) &&
					void 0 !== t
						? t
						: 0) -
					s.clientTop,
				left:
					o.left +
					(null !== (n = null == a ? void 0 : a.scrollX) &&
					void 0 !== n
						? n
						: 0) -
					s.clientLeft,
		...
		MA = (e, t, n, o) => {
			...
			return v(o)
				? ((e, t, n) => {
						const o = B(
							'Function not supported on simulated event.',
						)
						return {
							bubbles: !0,
							cancelBubble: !1,
		...
		KA = (e, t) => {
			...
			return (r) =>
				e.on((e) => {
					...
					if (e.dragging) {
						const s =
								r.currentTarget === t.getDoc().documentElement,
							l = ((e, t) => ({
				...
				e.intervalId.clear(),
					e.dragging &&
						n.fold(
							...
							(n) =>
								WA(t, 'dragend', e.element, e.dataTransfer, n),
						)
			}),
				GA(e)
		},
					...
					if (((e) => 0 === e.button)(n)) {
						...
						if (
							...
							e.set({
								...
								screenY: n.screenY,
								maxX:
									(t.inline ? s.scrollWidth : a.offsetWidth) -
									2,
								maxY:
									(t.inline
										? s.scrollHeight
				...
				XC(e) ||
					...
					e.on('AfterSetSelectionRange', (e) => {
						...
						u(t) || (qo((r = o)) && 'mcepastebin' === r.id) || p(),
							((e) =>
								C(e) &&
								n.hasClass(e, 'mce-offscreen-selection'))(o) ||
								g()
					}),
					((e) => {
						XA(e),
		...
		fT = (e, t, n) => {
			const o = rT(e.getRoot(), n).getOrDie(
					...
					const i = vT(
						...
						m = ((e, t, n, o, r, s = !1) => {
							if (0 === t.start.length && !s) {
								const t = e.createRng()
								return (
									t.setStart(n, o), t.setEnd(n, o), I.some(t)
								)
							}
					...
					: (e.on('keydown', (t) => {
					  ...
					  l &&
							(e.on('keydown', (t) => {
								if (!g(t) && t.keyCode === n) {
									if (
										!e.getBody().getElementsByTagName('hr')
											.length
									)
										return
									if (
							...
							(() => {
								const n = () => {
										const n = r.getAttribs(
											s.getStart().cloneNode(!1),
										)
										return () => {
											const o = s.getStart()
											o !== e.getBody() &&
		...
		OT = (e) => {
			...
			const a = Promise.all(
					((e, t, n) => {
						...
						return e.inline
							? a
							: a.concat([e.ui.styleSheetLoader.loadAll(n)])
					})(e, o, n),
				)
					.then(s)
					.catch(s),
		...
		PT = (e) => {
			...
			;(o.disabled = !0),
				...
				((e) => {
					;((e) => {
						e.on('click', (t) => {
							e.dom.getParent(t.target, 'details') &&
								t.preventDefault()
						})
					})(e),
						((e) => {
			...
			const s = ((e) => {
				const t = e
				return ((e) =>
					xe(e.plugins, 'rtc').bind((e) => I.from(e.setup)))(e).fold(
						...
						;((e, t, n) => {
							const o = Ow.get(n),
								r =
									...
									e.documentBaseUrl.replace(/\/$/, '')
							if (
								((n = Pt.trim(n)), o && -1 === Pt.inArray(t, n))
							) {
					...
					: ((e, t) => {
							;((e, t) => {
								const n = e.translate('Rich Text Area'),
									o = tn(yn(e.getElement()), 'tabindex').bind(
										Xe,
									),
									r = ((e, t, n, o) => {
										const r = bn('iframe')
								...
								t.editorContainer &&
									((t.editorContainer.style.display =
										e.orgDisplay),
									(e.hidden = LT.isHidden(
										t.editorContainer,
									))),
								(e.getElement().style.display = 'none'),
								LT.setAttrib(e.id, 'aria-hidden', 'true'),
								(e.getElement().style.visibility =
									e.orgVisibility),
								((e) => {
		...
		dO = (e, t) => {
			if (/^[0-9.]+$/.test(t)) {
				...
				if (n >= 1 && n <= 7) {
					const o = ((e) =>
							Pt.explode(
								e.options.get('font_size_style_values'),
							))(e),
						r = ((e) =>
							Pt.explode(e.options.get('font_size_classes')))(e)
					...
					;((e) => {
						...
						((e) => {
							...
							e.editorCommands.addCommands(
								...
								e.editorCommands.addQueryValueHandler(
									'FontName',
									() =>
										((e) =>
											lO(e, (t) =>
	...
	class pO {
		...
		queryCommandState(e) {
			if (
				(!gO(e) && this.editor.quirks.isHidden()) ||
				this.editor.removed
			)
				return !1
			const t = e.toLowerCase(),
				...
				: yO(e) &&
				  ((e, t) => {
						if (
							...
							const n = yn(t.target)
							;((e, t) =>
								no(t, 'a', (t) => _n(t, yn(e.getBody()))).bind(
									(e) => tn(e, 'href'),
								))(e, n).each((n) => {
								if ((t.preventDefault(), /^#/.test(n))) {
									...
									t.length &&
										e.selection.scrollIntoView(t[0], !0)
								} else
									window.open(
										n,
										'_blank',
						...
						;((e, t, n) => {
							...
							t
								? (e.selection.controlSelection.hideResizeRect(),
								  e._selectionOverrides.hideFakeCaret(),
								  ((e) => {
										I.from(e.selection.getNode()).each(
											(e) => {
												e.removeAttribute(
													'data-mce-selected',
												)
	...
	class YO {
				...
				const n = {},
					...
					r = (e, t, n) => {
						...
						return DO(r)
							...
							: (console.warn(
									PO(
										`Invalid value passed for the ${e} option`,
										r,
									),
							  ),
							  !1)
							...
							processor: (e) =>
								E(e, f) || !1 === e
									...
									: {
											valid: !1,
											message:
												'Must be an array of objects or false.',
									  },
							default: [
			...
			;((e) => {
				...
				s &&
					...
					Sd(e) &&
						!Zo(e.getElement()) &&
						(zT.insertAfter(
							zT.create('input', { type: 'hidden', name: t }),
							t,
						),
						(e.hasHiddenInput = !0)),
		...
		load(e = {}) {
			...
			if (n) {
				...
				return (
					o.no_events ||
						t.dispatch('LoadContent', { ...o, element: n }),
					s
				)
			}
			return ''
		...
		getContainer() {
			...
			return (
				e.container ||
					(e.container =
						e.editorContainer || VO.get(e.id + '_parent')),
				e.container
			)
		}
		...
		setEditableRoot(e) {
			;((e, t) => {
				e._editableRoot !== t &&
					((e._editableRoot = t),
					e.readonly ||
						((e.getBody().contentEditable = String(
							e.hasEditableRoot(),
						)),
						e.nodeChanged()),
					((e, t) => {
	...
	const eB = (e) => {
		...
		tB = (e) => {
			if (e !== JO) {
				const t = za.DOM
				e
					? (t.bind(window, 'resize', eB),
					  t.bind(window, 'scroll', eB))
					: (t.unbind(window, 'resize', eB),
					...
					GO.unbind(window, 'ready', s),
						...
						0 === i.length
							...
							: XO(i, (s) => {
									;((e, t) =>
										e.inline &&
										t.tagName.toLowerCase() in o)(e, s)
										? Fw(
	...
	const sB = (() => {
		...
		uB = {
			inflate: (e, t, n) =>
				cB(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
			relativePosition: dB,
